...
head:
  - - meta
    - name: keywords
      content: 最大似然估计, 线性回归, MSE, 最大似然， MLE
...
$$
P(6\text{正}4\text{反} \ |\ \theta=0.5)=C_{10}^{6}\times 0.5^6 \times (1-0.5)^4 \approx 0.2051 \\
P(6\text{正}4\text{反} \ |\ \theta=0.6)=C_{10}^{6}\times 0.6^6 \times (1-0.6)^4 \approx 0.2508 \\
P(6\text{正}4\text{反} \ |\ \theta=0.9)=C_{10}^{6}\times 0.9^6 \times (1-0.9)^4 \approx 0.0112
$$
...
![“6正4反”的似然函数](http://aixingqiu-1258949597.cos.ap-beijing.myqcloud.com/2020-05-24-135208.png)
...
接下来对公式参数求解，[线性回归的求解](./minimise-loss-function.md)一文已经详细推导过：
