...
![图1 互相关运算输出第一个元素计算过程](http://aixingqiu-1258949597.cos.ap-beijing.myqcloud.com/2020-11-03-021859.png){: .align-center}
*图1 互相关运算输出第一个元素计算过程*

接着，我们向右移动输入矩阵的深色部分，得到第二个输出元素。同样，计算的过程也是输入矩阵的深色部分与核一一相乘。

![图2 互相关运算输出第二个元素计算过程](http://aixingqiu-1258949597.cos.ap-beijing.myqcloud.com/2020-11-03-021856.png){: .align-center}
*图2 互相关运算输出第二个元素计算过程*
...
![图3 输入矩阵与核矩阵进行卷积操作](http://aixingqiu-1258949597.cos.ap-beijing.myqcloud.com/2020-11-03-021853.png){: .align-center}
*图3 输入矩阵与核矩阵进行卷积操作*
...
![图4 两个矩阵之间进行卷积运算](http://aixingqiu-1258949597.cos.ap-beijing.myqcloud.com/2020-11-03-021850.png){: .align-center}
*图4 两个矩阵之间进行卷积运算*
...
![图5 对同意图片使用不同卷积核的效果](http://aixingqiu-1258949597.cos.ap-beijing.myqcloud.com/2020-11-03-021847.png){: .align-center}
*图5 对同一图片使用不同卷积核的效果*
...
<img src="http://aixingqiu-1258949597.cos.ap-beijing.myqcloud.com/2020-11-03-021844.gif">
![图6 不同5*5卷积核经过梯度下降算法后不断变化的过程](http://aixingqiu-1258949597.cos.ap-beijing.myqcloud.com/2020-11-03-021844.png){: .align-center}
...
![图7 Padding](http://aixingqiu-1258949597.cos.ap-beijing.myqcloud.com/2020-11-03-021841.png){: .align-center}
*图7 Padding*
...
![图8 Stride](http://aixingqiu-1258949597.cos.ap-beijing.myqcloud.com/2020-11-03-021837.png){: .align-center}
*图8 Stride*
