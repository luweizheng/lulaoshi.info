...
summary: "数据相关的职位分为三类：数据分析师、大数据工程师和算法工程师。数据分析师需要丰富的领域知识和敏感的业务思维；大数据工程师为数据分析提供了数据基础和分析工具，需要掌握Spark和Flink等大数据技术，对编程和逻辑思维要求较高；算法工程师的技术要求最高，不仅要懂业务，会大数据，还要熟悉机器学习算法，并且能够将机器学习模型部署到生产环境。当然，因为优质算法工程师稀缺，他们的薪资水平最高。"
categories: [职场]
---
...
![今日头条内容分析报告](http://aixingqiu-1258949597.cos.ap-beijing.myqcloud.com/2020-05-31-064252.png)
*今日头条内容分析报告*
